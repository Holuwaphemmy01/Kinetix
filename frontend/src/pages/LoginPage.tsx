          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <button className="flex items-center justify-center gap-2 py-2.5 border border-slate-200 dark:border-slate-700 rounded-lg hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors font-medium text-slate-900 dark:text-white">
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                <path d="M17.05 20.28c-.96.95-2.12 1.43-3.48 1.43-1.05 0-2-.31-2.85-.92-.85-.62-1.78-.92-2.79-.92-1.01 0-1.94.3-2.79.92-.85.61-1.8.92-2.85.92-1.36 0-2.52-.48-3.48-1.43C-2 18.33-1 12.87 2.37 9.17c1.32-1.46 3-2.19 5.05-2.19 1.14 0 2.1.28 2.88.85.78.57 1.45.85 2 .85.55 0 1.22-.28 2-.85.78-.57 1.74-.85 2.88-.85 1.05 0 1.99.21 2.82.63s1.5 1.02 2.01 1.8c-2.19 1.26-3.28 3.14-3.28 5.64 0 1.95.73 3.56 2.2 4.83-.56.88-1.39 1.68-2.5 2.45M12.03 7.25c-.15-2.23.63-4.14 2.34-5.74 2.1 1.57 3.15 3.54 3.15 5.9.15.11.15.22.15.33-2.25 0-4.13-.15-5.64-.49"></path>
              </svg>
              Apple
            </button>
          </div>
